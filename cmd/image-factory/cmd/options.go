...
func (o *Options) Validate() error {
	...
	// Node tokens only apply to the Auth0 provider, since org_id identity comes from it.
	if o.Authentication.Enabled && o.Authentication.Provider == AuthProviderAuth0 {
