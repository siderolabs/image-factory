...
require (
	...
	github.com/siderolabs/talos v1.7.0-alpha.1
...
require (
	...
	k8s.io/api v0.30.0-beta.0 // indirect
	k8s.io/apimachinery v0.30.0-beta.0 // indirect
	k8s.io/apiserver v0.30.0-beta.0 // indirect
	k8s.io/client-go v0.30.0-beta.0 // indirect
	k8s.io/component-base v0.30.0-beta.0 // indirect
	k8s.io/cri-api v0.30.0-beta.0 // indirect
