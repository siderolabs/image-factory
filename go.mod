...
require (
	...
	github.com/siderolabs/talos v1.7.0-alpha.1.0.20240401172158-fac3dd04308b
	github.com/siderolabs/talos/pkg/machinery v1.7.0-alpha.1.0.20240401172158-fac3dd04308b
...
require (
	...
	github.com/cosi-project/runtime v0.4.0-alpha.9 // indirect
	...
	k8s.io/api v0.30.0-rc.0 // indirect
	k8s.io/apimachinery v0.30.0-rc.0 // indirect
	k8s.io/apiserver v0.30.0-rc.0 // indirect
	k8s.io/client-go v0.30.0-rc.0 // indirect
	k8s.io/component-base v0.30.0-rc.0 // indirect
	k8s.io/cri-api v0.30.0-rc.0 // indirect
