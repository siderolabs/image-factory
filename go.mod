...
require (
	...
	github.com/siderolabs/talos v1.13.0-alpha.0.0.20251226110949-d98b415afea7
	github.com/siderolabs/talos/pkg/machinery v1.13.0-alpha.0.0.20251226110949-d98b415afea7
