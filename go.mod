...
require (
	...
	github.com/siderolabs/talos v1.13.0-alpha.0.0.20251226093315-226cd6bc1d70
	github.com/siderolabs/talos/pkg/machinery v1.13.0-alpha.0.0.20251226093315-226cd6bc1d70
