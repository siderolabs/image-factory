...
require (
	...
	github.com/siderolabs/talos v1.14.0-beta.1.0.20260821085822-a72281e5b98d
	github.com/siderolabs/talos/pkg/machinery v1.14.0-beta.1.0.20260821085822-a72281e5b98d
